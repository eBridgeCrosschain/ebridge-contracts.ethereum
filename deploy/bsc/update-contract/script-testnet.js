    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            if (attempt < maxRetries) {
                ...
                console.log(`   npx hardhat verify --network bsc-testnet ${contractAddress}`);
                return false;
            }
        }
    }
...
async function main() {
    console.log("\n🚀 ===== BSC TESTNET CONTRACT UPGRADE SCRIPT =====");
    ...
    console.log(`\n📊 EXECUTION SUMMARY:`);
    console.log(`   ✅ ${completedOperations} upgrade operation(s) completed successfully on BSC Testnet`);
    ...
    console.log(`🔗 All completed upgrades are now live and verified on the BSC Testnet blockchain!`);
